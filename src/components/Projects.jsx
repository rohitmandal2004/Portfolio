...
const Projects = () => {
  ...
  const handleLinkClick = (e, url) => {
    ...
    // Simulate rocket/arcade launch animation duration before redirect
    setTimeout(() => {
    ...
    <>
      {isLaunching && (
        <div className="arcade-overlay">
          <div className="pixel-explosion"></div>
          <div className="arcade-content">
            <h2 className="arcade-text blink">REDIRECTING...</h2>
            <div className="arcade-loading-bar">
              <div className="arcade-progress"></div>
            </div>
            <p className="arcade-subtext">PLEASE WAIT...</p>
          </div>
        </div>
      )}
